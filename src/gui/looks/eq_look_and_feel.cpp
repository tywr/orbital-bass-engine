...
void EqLookAndFeel::drawButtonBackground(
...
void EqLookAndFeel::drawButtonText(
...
void EqLookAndFeel::drawToggleButton(
...
void EqLookAndFeel::drawRotarySlider(
...
void EqLookAndFeel::drawLinearSlider(
    juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
    float minSliderPos, float maxSliderPos,
    const juce::Slider::SliderStyle style, juce::Slider& slider
)
{
    juce::ignoreUnused(style, minSliderPos, maxSliderPos);

    float thumbSizeX = 8.0f;
    float thumbSizeY = 16.0f;

    // Draw background
    g.setColour(ColourCodes::grey0);
    g.fillRect(x + (width - thumbSizeX) / 2.0f, (float)y, thumbSizeX, (float)height);

    // Draw thumb
    juce::Rectangle<float> thumb(
        x + (width - thumbSizeX) / 2.0f, // Center horizontally
        sliderPos - thumbSizeY / 2.0f,   // Center on slider position
...
void EqLookAndFeel::drawTabbedButtonBarBackground(
...
void EqLookAndFeel::drawTabButton(
...
void EqLookAndFeel::drawLabel(juce::Graphics& g, juce::Label& label)
{
